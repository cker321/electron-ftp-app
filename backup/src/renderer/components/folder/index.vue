<template>
    <div class="folder"
        ...
        <CAddFile ref="addFileRef"
                 ...
                 @uploadSuccess="handleUploadSuccess"></CAddFile>
        <CAddFolder ref="addFolderRef"
                   dialogVisible="dialogVisible"
                   @uploadSuccess="handleUploadSuccess"></CAddFolder>
    </div>
</template>

<script>
    import CAddFile from '../addFile/addFile'
    import CAddFolder from '../addFolder/addFolder'
    ...
    export default {
        ...
        methods: {
            ...
            addFile() {
                this.$refs.addFileRef.showDialog();
            },
            addFolder() {
                this.$refs.addFolderRef.showDialog();
            },
            back() {
